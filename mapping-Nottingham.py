...
file1 = 'data/nottingham.flatmates.json'
file2 = 'data/nottingham.rooms.json'
file3 = 'data/nottingham.roomsCount.json'
...
m2 = MyBasemap(resolution='i',  # c (crude), l, i, h, f (full) or None
            projection='merc',  # see: http://matplotlib.org/basemap/users/mapsetup.html
            # westlimit=-1.726886; southlimit=52.739423; eastlimit=-1.268207; northlimit=53.032349
            lat_0=52.885, lon_0=-1.50,  # centre point of your map
            llcrnrlon = -1.73, llcrnrlat = 52.74,  # lower left corner
            urcrnrlon = -1.27, urcrnrlat = 53.03, ax=ax7)  # upper right corner
