...
file1 = 'data/manchester.flatmates.json'
file2 = 'data/manchester.rooms.json'
file3 = 'data/manchester.roomsCount.json'
...
m2 = MyBasemap(resolution='i',  # c (crude), l, i, h, f (full) or None
            projection='merc',  # see: http://matplotlib.org/basemap/users/mapsetup.html
            # westlimit=-2.747458; southlimit=53.346343; eastlimit=-1.9569; northlimit=53.652398
            lat_0=53.50, lon_0=-2.3535,  # centre point of your map
            llcrnrlon = -2.75, llcrnrlat = 53.35,  # lower left corner
            urcrnrlon = -1.957, urcrnrlat = 53.65, ax=ax7)  # upper right corner
